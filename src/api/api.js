...
export const logout = function () {
  return axios.post(base + root + '/engine-console/console/sysUser/logout.do')
}
...
export const deleteMerchant = params => {
  return axios.post(base + root + '/engine-console/console/cmarketMerchant/delete.do', params)
}
...
export const updateOrderNo = params => {
  return axios.post(base + root + '/engine-console/console/adPlan/updateOrderNo.do', params)
}
// 广告管理结束
...
export const updateAdPlanMark = params => {
  return axios.post(base + root + '/engine-console/console/adPlan/updateAdPlan.do', params)
}

export const associatedAd = params => {
  return axios.post(base + root + '/engine-console/console/cmarketMerchantAd/associatedAd.do', params)
}

export const addAdPlanMark = params => {
  return axios.post(base + root + '/engine-console/console/adPlan/addAdPlan.do', params)
}

export const markTable = params => {
  return axios.post(base + root + '/engine-console/console/cmarketMerchantAd/searchCMarketMerchantAdALL.do', params)
}

export const searchAdPlan = params => {
  return axios.post(base + root + '/engine-console/console/adPlan/searchAdPlan.do', params)
}

export const offline = params => {
  return axios.post(base + root + '/engine-console/console/cmarketMerchantAd/offlineCMarketMerchantAd.do', params)
}

export const merchantAdDtai = params => {
  return axios.post(base + root + '/engine-console/console/cmarketMerchantAd/cMarketMerchantAdDtail.do', params)
}

// 立即上线
export const immediatelyOnline = params => {
  return axios.post(base + root + '/engine-console/console/adPlan/immediatelyOnline.do', params)
}
