        ...
        <el-table
          ...
          <el-table-column
            ...
            <template scope="scope">
              <span>{{scope.row.adStatus == 'ON' ? '已上架' : scope.row.adStatus == 'W' ? '待上架' : scope.row.adStatus == 'I' ? '待处理' :'已下架'}}</span>
            </template>
          </el-table-column>
          <el-table-column
         ...
         let vm = this
            ...
            adPlanDetail(perem).then(data => {
                if (data.data.code === 200) {
                    ...
                    // tableData.adStatus
                    // console.log(vm.tableData.adStatus)
                    if(vm.tableData.adStatus !="OFF"){
                            vm.isShow = true
                    }else{
                       vm.isShow = false
                    }
