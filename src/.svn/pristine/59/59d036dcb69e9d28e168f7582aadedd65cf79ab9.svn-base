...
<!--编辑界面-->
    ...
    <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
        <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
            ...
            <el-form-item label="广告名称" prop="adName">
                <el-input v-model.trim="addForm.adName" auto-complete="off" type="text" placeholder="请输入申广告名称，建议输入30个字符以内"></el-input>
            </el-form-item>
            <el-form-item label="标签" prop="tags">
                <el-input v-model.trim="addForm.tags" auto-complete="off" type="text" placeholder="请以英文分号隔开"></el-input>
            </el-form-item>
             <!-- <el-form-item label="广告名称" prop="details">
                <el-input v-model.trim="addForm.details" auto-complete="off" type="text" placeholder="请输入申广告名称，建议输入22个字符以内"  ></el-input>
            </el-form-item> -->
            <el-form-item label="目标路径" prop="targetUrl">
...
export default {
  data() {
    ...
    return {
      ...
      addFormRules: {
        insideMerchantId: [{type: "number", required: true, message: "请输入广告商名称", trigger: "blur" }],
        // adName: [{ required: true, message: "请输入30个以内字符的广告名称", trigger: "blur" }],
        adName: [{max: 30,required: true, message: "请输入30个字符以内的广告名称", trigger: "blur"}],
        tags: [
          { required: true, message: "请输入标签", trigger: "blur" },
          { required: true, trigger: "blur", validator: validatetag }
        ],
