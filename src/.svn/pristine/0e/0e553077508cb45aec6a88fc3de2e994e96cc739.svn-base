    ...
    computed: {
      searchData () {
        ...
        if (search) {
          ...
          let searchResData = this.tableData.filter(function (item) {
          ...
          this.total = searchResData.length
          searchResData = searchResData.slice((this.currentPage - 1) * 10, (this.currentPage - 1) * 10 + this.pageSize)
