    ...
    <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
      ...
      :picker-options="endPickerOptions" @change="selectedEnd(editForm.onlineEndVO)">
        ...
        <el-form-item label="小图像" prop="img2" v-if="editForm.merchantId">
            <el-upload :headers="dataObjs" :data="dataObj2" class="avatar-uploader" :action="baseurl" :show-file-list="false" :on-success="handleAvatarSuccessImg2">
...
<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
    <el-form :model="addForm" label-width="80px" :rules="addFormRules" ref="addForm">
        ...
        <el-form-item label="小图像" prop="img2" v-if="name">
            <el-upload :headers="dataObjs" :data="dataObj2" class="avatar-uploader" :action="baseurl" :show-file-list="false" :on-success="handleAvatarSuccessImg4">
    ...
    export default {
        data() {
            ...
            return {
                ...
                dataObj: { cmarketMerchantId: '', flag: 2},
                dataObj2: { flag: 1 },
        ...
        computed: {
            ...
            name(){
                this.dataObj.cmarketMerchantId = this.addForm.merchantId
        ...
        methods: {
            ...
            handleEdit(index, row) {
                ...
                this.dataObj.cmarketMerchantId = this.editForm.merchantId
            },
            // 显示新增界面
            handleAdd () {
